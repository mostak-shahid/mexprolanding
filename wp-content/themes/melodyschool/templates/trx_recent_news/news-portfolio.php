...
if ( !function_exists( 'melodyschool_template_news_portfolio_theme_setup' ) ) {
	add_action( 'melodyschool_action_before_init_theme', 'melodyschool_template_news_portfolio_theme_setup', 1 );
	function melodyschool_template_news_portfolio_theme_setup() {
		melodyschool_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'melodyschool'),
...
// Template output
if ( !function_exists( 'melodyschool_template_news_portfolio_output' ) ) {
	function melodyschool_template_news_portfolio_output($post_options, $post_data) {
