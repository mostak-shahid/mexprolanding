...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('melodyschool_sc_parallax_theme_setup')) {
	add_action( 'melodyschool_action_before_init_theme', 'melodyschool_sc_parallax_theme_setup' );
	function melodyschool_sc_parallax_theme_setup() {
		add_action('melodyschool_action_shortcodes_list', 		'melodyschool_sc_parallax_reg_shortcodes');
		if (function_exists('melodyschool_exists_visual_composer') && melodyschool_exists_visual_composer())
			add_action('melodyschool_action_shortcodes_list_vc','melodyschool_sc_parallax_reg_shortcodes_vc');
	}
}
...
if (!function_exists('melodyschool_sc_parallax')) {	
	function melodyschool_sc_parallax($atts, $content=null){	
		...
		if ($bg_video!='') {
			...
			$bg_video_width = !empty($width) && melodyschool_substr($width, -1) >= '0' && melodyschool_substr($width, -1) <= '9'  ? $width : 1280;
		...
		$css .= melodyschool_get_css_dimensions_from_values($width, $height)
			...
			;
		$output = (melodyschool_param_is_on($gap) ? melodyschool_gap_start() : '')
			...
			. '</div>'
			. '</div>'
			. (melodyschool_param_is_on($gap) ? melodyschool_gap_end() : '');
		return apply_filters('melodyschool_shortcode_output', $output, 'trx_parallax', $atts, $content);
	}
	add_shortcode('trx_parallax', 'melodyschool_sc_parallax');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'melodyschool_sc_parallax_reg_shortcodes' ) ) {
	//add_action('melodyschool_action_shortcodes_list', 'melodyschool_sc_parallax_reg_shortcodes');
	function melodyschool_sc_parallax_reg_shortcodes() {
	
		melodyschool_sc_map("trx_parallax", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'melodyschool_sc_parallax_reg_shortcodes_vc' ) ) {
	//add_action('melodyschool_action_shortcodes_list_vc', 'melodyschool_sc_parallax_reg_shortcodes_vc');
	function melodyschool_sc_parallax_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Parallax extends MELODYSCHOOL_VC_ShortCodeCollection {}
	}
}
?>