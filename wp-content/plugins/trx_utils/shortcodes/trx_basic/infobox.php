...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('melodyschool_sc_infobox_theme_setup')) {
	add_action( 'melodyschool_action_before_init_theme', 'melodyschool_sc_infobox_theme_setup' );
	function melodyschool_sc_infobox_theme_setup() {
		add_action('melodyschool_action_shortcodes_list', 		'melodyschool_sc_infobox_reg_shortcodes');
		if (function_exists('melodyschool_exists_visual_composer') && melodyschool_exists_visual_composer())
			add_action('melodyschool_action_shortcodes_list_vc','melodyschool_sc_infobox_reg_shortcodes_vc');
	}
}
...
if (!function_exists('melodyschool_sc_infobox')) {	
	function melodyschool_sc_infobox($atts, $content=null){	
		...
		$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '') 
				. ' class="sc_infobox sc_infobox_style_' . esc_attr($style) 
					. (melodyschool_param_is_on($closeable) ? ' sc_infobox_closeable' : '') 
					. (!empty($class) ? ' '.esc_attr($class) : '') 
					. ($icon!='' && !melodyschool_param_is_inherit($icon) ? ' sc_infobox_iconed '. esc_attr($icon) : '') 
					. '"'
				...
				. trim($content)
				. '</div>';
		return apply_filters('melodyschool_shortcode_output', $output, 'trx_infobox', $atts, $content);
	}
	add_shortcode('trx_infobox', 'melodyschool_sc_infobox');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'melodyschool_sc_infobox_reg_shortcodes' ) ) {
	//add_action('melodyschool_action_shortcodes_list', 'melodyschool_sc_infobox_reg_shortcodes');
	function melodyschool_sc_infobox_reg_shortcodes() {
	
		melodyschool_sc_map("trx_infobox", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'melodyschool_sc_infobox_reg_shortcodes_vc' ) ) {
	//add_action('melodyschool_action_shortcodes_list_vc', 'melodyschool_sc_infobox_reg_shortcodes_vc');
	function melodyschool_sc_infobox_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Infobox extends MELODYSCHOOL_VC_ShortCodeContainer {}
	}
}
?>