...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by MelodySchool
	 * @var $inverse	- added by MelodySchool
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by MelodySchool:
	// Color scheme
	if ($scheme && !melodyschool_param_is_off($scheme) && !melodyschool_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !melodyschool_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add MelodySchool color scheme in the row
	if ($scheme && !melodyschool_param_is_off($scheme) && !melodyschool_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php melodyschool_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php melodyschool_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
