...
if ( !function_exists( 'trx_utils_core_frontend_scripts' ) ) {
    function trx_utils_core_frontend_scripts() {
        // Google map
        if ( melodyschool_get_custom_option('show_googlemap')=='yes' ) {
        ...
        if ( is_single() && melodyschool_get_custom_option('show_reviews')=='yes' ) {
            wp_enqueue_script( 'melodyschool-core-reviews-script', trx_utils_get_file_url('js/core.reviews.js'), array('jquery'), null, true );
        }
    }
}
...
if (!function_exists('trx_utils_post_admin_scripts')) {
    function trx_utils_post_admin_scripts() {
        if (function_exists('melodyschool_storage_get_array') && melodyschool_storage_get_array('post_override_options', 'page')=='post' && melodyschool_storage_isset('options', 'show_reviews'))
            wp_enqueue_script( 'melodyschool-core-reviews-script', trx_utils_get_file_url('js/core.reviews.js'), array('jquery'), null, true );
    }
}
...
// $d = trx_utils_array_merge($a, $b);	["four", "k2"=>"six", "seven", "k1"=>"five");
...
if ( ! function_exists( 'melodyschool_trx_utils_privacy_text' ) ) {
    add_filter( 'trx_utils_filter_privacy_text', 'melodyschool_trx_utils_privacy_text' );
    function melodyschool_trx_utils_privacy_text( $text='' ) {
...
if (!function_exists('melodyschool_footer_add_scroll_to_top')) {
    add_action('wp_footer', 'melodyschool_footer_add_scroll_to_top', 1);
    function melodyschool_footer_add_scroll_to_top() {
